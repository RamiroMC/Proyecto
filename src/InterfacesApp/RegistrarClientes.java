...
public class RegistrarClientes extends javax.swing.JPanel {
    ...
    try {
        ...
        if (contieneNumeros(nombreCliente)) {
            throw new IllegalArgumentException("El nombre no debe contener números.");
        }

        if (contieneLetras(idCliente)) {
            throw new IllegalArgumentException("La ID no debe contener letras.");
        }

        if (!validarTipoVehiculo()) {
            throw new IllegalArgumentException("Selecciona solo un tipo de vehículo.");
        }

        if (contieneNumeros(marcaVehiculo)) {
            throw new IllegalArgumentException("La marca no debe contener números.");
        }

        if (contieneNumeros(colorVehiculo)) {
    ...
    //Metodo auxiliar para validar que solo contenga letras. 
    ...
    //Metodo auxiliar para validar que solo contenga números. 
    ...
    //Metodo auxiliar, para que se valide que solo se puede seleccionar un tipo de vehiculo. 
